...
/**
 * Created by YJH on 2016/11/30 16:49.
 */
public class MenuViewTypeAdapter extends SwipeMenuAdapter<MenuViewTypeAdapter.DefaultViewHolder> {
    ...
    public View onCreateContentView(ViewGroup parent, int viewType) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.item_activity_lv_update_single, parent, false);
    }
    ...
    static class DefaultViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public DefaultViewHolder(View itemView) {
            ...
            tvTitle = (TextView) itemView.findViewById(R.id.tv_item_LVUpdateSingleAct);
        }
